...
хватает для отопления всего объема торгового центра - выводится 'Бюджета достаточно', если нет - 
'Бюджета недостаточно'. И все 🙂
...
function isBudgetEnough(data) {
    ...
    let allShopsP = 0;
    for (let i in shops) {
        allShopsP += shops[i].width * shops[i].length;
    }
    let allShopsM3 = allShopsP * data.height;
    let nado = allShopsM3 * data.moneyPer1m3;
    if (nado > data.budget) {
